...
public partial class InitialCreate : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.InsertData(
            ...
            values: new object[,]
            {
                { 1, new DateTime(2026, 5, 8, 9, 0, 0), "Gaming Beast X", 5, 36, 12.5f },
                { 2, new DateTime(2026, 4, 15, 13, 30, 0), "Office Mini Pro", 12, 24, 4.2f },
                { 3, new DateTime(2026, 3, 1, 10, 0, 0), "Budget Student PC", 8, 12, 6.7f }
            });
